    ...
    <>
      ...
      >
        <h1 style={{ marginLeft: ".5%" }}>
          Home - {sessionStorage.getItem("name")}
        </h1>
          ...
          {plan === null ? (
            ...
            >
              <div style={{ float: "left", width: "49%", marginLeft: ".5%" }}>
                ...
                <p style={{ marginBottom: "0px", fontSize: "16pt" }}>
                  {plan.name}{" "}
                </p>
              ...
              >
                <p style={{ marginBottom: "0px", fontSize: "12pt" }}>
                  Deductible: ${plan.deductible}{" "}
                </p>
                <p style={{ marginBottom: "0px", fontSize: "12pt" }}>
                  Primary Care Copay: ${plan.physiciancopay}
                </p>
                <p style={{ marginBottom: "0px", fontSize: "12pt" }}>
                  Pharmacy Copay: ${plan.pharmacopay}
                </p>
              </div>
            </div>
          )}
            ...
            >
              <tbody>
                {upcoming.map((appt, i) => (
                  <tr
                    key={i}
                    style={{ border: ".75px solid", borderColor: "gray" }}
                  >
                    <td>
                      <div
                        style={{
